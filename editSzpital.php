...
<html>
    <head>
        <script src="Controllers/EditSzpitalController.js" type="text/javascript"></script>
    </head>
    <html>
        <body >
            <div  class="container">
                <div class="row">
                    <div class="col-md-12">
                        <form class="form-horizontal" role="form" id="EditSzpitalForm" name="EditSzpitalForm" >
                            <div class="form-group form-buffer-pa">
                                <h2>nazwa</h2>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">ID Szpitala</label>
                                    <div class="col-sm-3">
                                        <input type="text" name="idSzpital" id="idSzpital" disabled/>
                                    </div>    
                                </div>
                                <p class="col-sm-12"></p>
